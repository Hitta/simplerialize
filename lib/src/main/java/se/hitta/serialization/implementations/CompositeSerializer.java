...
/**
 * This class is {@link Deprecated} since it's a non-complete implementation of 
 * the {@link Serializer} interface. Specifically calls to
 * {@link Serializer#getMapper()} won't work.
 * <br/><br/>
 * It was developed as thought experiment and may be used to ease comparison of
 * JSON and XML serialization without having to explicitly manage one
 * {@link Serializer} instance per format. <strong>Don't use it</strong>
 ...
 * {@link CompositeSerializer#wrap(Serializer...)}.
 */
@Deprecated
