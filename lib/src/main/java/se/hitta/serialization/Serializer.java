...
public interface Serializer
{
    ...
    /**
     * Finish and flush any remaining output, <strong>don't ever</strong> call
     * it from within a {@link SerializationAdapter}.
     * 
     * @throws IOException if there's either a format problem (ie your usage of
     * the library produced illegal XML or JSON) or if an {@link IOException}
     * occurs when writing to the underlying {@link OutputStream} or
    ...
    /**
     * Get the {@link AdapterMapper} used by this {@link Serializer}.
     * 
     * @return The {@link AdapterMapper} used by this instance
     */
    AdapterMapper getMapper();
